...
class QuadEQPlot:
    ...
    def init_widget(self):
        ...
        # tkinter.Frame(self.root, bg="white")

        self.labelframe = tkinter.Frame(self.root)
        self.eqationLabel = Label(self.labelframe, text=self.eqation)
        self.R1 = Radiobutton(self.labelframe, text="Points", command=self.plot_points)
        self.R2 = Radiobutton(self.labelframe, text="Lines", command=self.plot_line)
    ...
    def plot_line(self):
        ...
        try:
            ...
            for i in range(len(self.x_values)):
                self.canvas.create_line(lines_cordionates[i][0], lines_cordionates[i][1], lines_cordionates[i + 1][0],
                                        lines_cordionates[i + 1][1], fill='darkblue')
        except:
            pass
